...
export class ProjectsComponent {
  ...
  projects: Project[] = [
    ...
    {id: 2, name: "C#", description: "C#-kieleen tutustuin Lapin AMKiin tultuani. Unity-peliohjelmoinnin kurssilla C# oli oleellisena osana käytössä. Myös olio-ohjelmoinnin kurssilla käytettiin C#-kieltä.", images: [{name: "unity.png", altText: "Unity-projekti työn alla."}]},
